export class MathUtils {
  static map_into_range(x: number, range1_min: number, range1_max: number, range2_min: number, range2_max: number) {
    return ((x - range1_min) / (range1_max - range1_min)) * (range2_max - range2_min) + range2_min;
  }
}
...
export class Mat4 {
  ...
  //from glMatrix
  static perspective(out: Float32Array, fov: number, aspect: number, near: number, far: number) {
  ...
  static multiplyVector(mat4: Float32Array, vec4: [number, number, number, number]) {
    const x = vec4[0];
    const y = vec4[1];
    const z = vec4[2];
    const w = vec4[3];
  ...
  static transform_to_vec4(out: Float32Array, vec4: [number, number, number, number], mat4: Float32Array) {
    out[0] = mat4[0] * vec4[0] + mat4[4] * vec4[1] + mat4[8] * vec4[2] + mat4[12] * vec4[3];
    out[1] = mat4[1] * vec4[0] + mat4[5] * vec4[1] + mat4[9] * vec4[2] + mat4[13] * vec4[3];
    out[2] = mat4[2] * vec4[0] + mat4[6] * vec4[1] + mat4[10] * vec4[2] + mat4[14] * vec4[3];
    out[3] = mat4[3] * vec4[0] + mat4[7] * vec4[1] + mat4[11] * vec4[2] + mat4[15] * vec4[3];
    return out;
  }
  ...
  static rotate(out: Float32Array, rad: number, axis: [number, number, number]) {
    let x = axis[0];
    let y = axis[1];
    let z = axis[2];

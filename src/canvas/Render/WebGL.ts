...
export class WebGL extends Resource {
	...
	create_mesh<T extends Mesh, Options extends {} | undefined>(
		factory: (gl: WebGL2RenderingContext, options: Options) => T,
		options: { id?: MeshID } & Options,
	) {
		const mesh: T = factory(this.gl, options);
